	...
	<table border="0" cellspacing="1" cellpadding="0" class="edit" width="100%">
		<tr>
			...
			<td width="*">
				...
				<input type="checkbox" id="participe_a_la_loi_c" name="participe_a_la_loi_c" value="1" tabindex="0" {php} if($this->_tpl_vars['fields']['participe_a_la_loi_c']['value'] == '1') echo 'CHECKED';{/php} disabled="disabled">
			</td>
		</tr>
		<tr>
			...
			<td width="*">
				...
				<input type="checkbox" id="is_offreur_de_formation_c" name="is_offreur_de_formation_c" value="1" tabindex="0" {php} if($this->_tpl_vars['fields']['is_offreur_de_formation_c']['value'] == '1') echo 'CHECKED';{/php} disabled="disabled">
			</td>
		</tr>
		<tr>
			...
			<td width="*">
				...
				<input type="checkbox" id="is_adherent_portail_c" name="is_adherent_portail_c" value="1" tabindex="0" {php} if($this->_tpl_vars['fields']['is_adherent_portail_c']['value'] == '1') echo 'CHECKED';{/php} disabled="disabled">
			</td>
		</tr>
		<tr>
			...
			<td width="*">
				...
				<input type="checkbox" id="is_adherent_repertoire_c" name="is_adherent_repertoire_c" value="1" tabindex="0" {php} if($this->_tpl_vars['fields']['is_adherent_repertoire_c']['value'] == '1') echo 'CHECKED';{/php} disabled="disabled">
			</td>
		</tr>
	</table>
</fieldset>